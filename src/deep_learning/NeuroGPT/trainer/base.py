    ...
    def compute_loss(
        ...
        **kwargs
        ...
        if isinstance(
            ...
            #exec(gen_cmd_print_variables('batch.size()', pfx_msg='aaaaaaaaaaaaa '))
        ...
        if self.state.is_local_process_zero:
            self.log({
                "loss": loss.item(),
                "loss_r": losses.get("loss_r", torch.tensor(0.0)).item(),
                "loss_a": losses.get("loss_a", torch.tensor(0.0)).item(),
                "loss_c": losses.get("loss_c", torch.tensor(0.0)).item()
            })
