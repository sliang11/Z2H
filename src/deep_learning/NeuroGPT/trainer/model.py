...
class Model(torch.nn.Module):
    ...
    def forward(
        ...
        if self.adapter is not None:
            batch['inputs'] = self.adapter(batch['inputs'])

            #a = batch['inputs']
            #exec(gen_cmd_print_variables('a.shape'))
        ...
        if self.encoder is not None:
            ...
            #exec(gen_cmd_print_variables('features.size()', pfx_msg="(((((((( "))
            ...
            if self.ft_only_encoder:
                ...
                #exec(gen_cmd_print_variables('return_batch', pfx_msg="111111111111 "))
                return (outputs, batch) if return_batch else outputs
            ...
            #print("***",b, f1, f2, nchunks)
            #print(b//nchunks, f1*f2)
