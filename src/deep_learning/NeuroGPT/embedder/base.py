...
class BaseEmbedder(torch.nn.Module):
    ...
    def prep_batch(
        ...
        for key in batch:
            ...
            elif key == 'labels'and batch['labels'] is not None:
    ...
    def loss(
        ...
        if self.is_decoding_mode:
            ...
            outputs['decoding_logits'] = outputs['outputs']
            #exec(gen_cmd_print_variables('inputs.shape, labels.shape', pfx_msg="(((((((( "))
            #exec(gen_cmd_print_variables('outputs.shape', pfx_msg="(((((((( "))
