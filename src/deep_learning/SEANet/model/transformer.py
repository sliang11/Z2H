# coding = utf-8
# credit: https://github.com/gzerveas/mvts_transformer/blob/3f2e378bc77d02e82a44671f20cf15bc7761671a/src/models/ts_transformer.py
...
class TSTransformerEncoderClassiregressor(nn.Module):
    ...
    def infer(self, input: Tensor, padding_masks) -> Tensor:
        with torch.no_grad():
            predictions = self.forward(input, padding_masks).detach().cpu().numpy()
